...
#remove redundant rules as seen on stackoverflow: 
  #http://stackoverflow.com/questions/23971823/removing-invertedreverse-duplicate-rules-from-apriori-result-in-r
# 
# subset.matrix <- is.subset(claims_rules, claims_rules)
# 
# subset.matrix[lower.tri(subset.matrix,diag=T)] <- NA
# 
# redundant <- colSums(subset.matrix,na.rm=T) >= 1
# 
# claims_rules_notR <- claims_rules[redundant]
...
# graph_from_edgelist(el = cbind(claims_rules_measures$First_disease, claims_rules_measures$Second_disease), directed = FALSE) %>% plot
...
# claims_ggnetwork <- 
#   claims_ggnetwork[!is.na(claims_ggnetwork$na.y),]
